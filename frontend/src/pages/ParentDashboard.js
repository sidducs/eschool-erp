...
import {
    FaUniversity, FaUserGraduate, FaChartPie, FaFileInvoiceDollar, FaSchool, FaChild,
        ...
        <div className="flex h-screen bg-slate-50 font-sans text-slate-900 overflow-hidden">
            ...
            <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-slate-900 text-slate-100 transition-transform duration-300 ease-in-out transform lg:relative lg:translate-x-0 ${showSidebar ? 'translate-x-0' : '-translate-x-full'} dark:bg-black border-r dark:border-slate-800`}>
                <div className="flex items-center justify-between h-16 p-6 bg-slate-950/50 sidebar-header">
                    <div className="flex items-center gap-2 hover:opacity-80 transition-opacity text-white cursor-pointer">
                        <FaUniversity className="text-blue-500 text-xl" />
                        <span className="font-bold text-lg tracking-tight uppercase">eSchool <span className="text-blue-400">ERP</span></span>
                    </div>
